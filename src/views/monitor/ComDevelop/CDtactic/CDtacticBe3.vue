...
<!-- 任务分析 -->
  <div class="monitoring">
    ...
    <div class="conter">
      ...
      <NavarChyJ2 class="Project"></NavarChyJ2>
...
import NavarChyJ2 from "@/components/NavarChyJ2/NavarChyBody/NavarChy16_J4-2/NavarChy16_1.vue";
export default {
  name: "Monitoring",
  components: {
    TaskConter,
  ...
  methods: {
    ...
    NavarchyHaveClick(index){
       this.$store.state.NavarchyP2=index
    }
  },
};
</script>
