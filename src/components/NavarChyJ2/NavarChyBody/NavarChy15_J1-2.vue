...
<script>
import Enemy1 from '@/components/NavarChyJ2/NavarChyBody/NavarChy15_J1-2/NavarChy15_1.vue'
import Enemy2 from '@/components/NavarChyJ2/NavarChyBody/NavarChy15_J1-2/NavarChy15_2.vue'
import Enemy3 from '@/components/NavarChyJ2/NavarChyBody/NavarChy15_J1-2/NavarChy15_3.vue'
import Enemy4 from '@/components/NavarChyJ2/NavarChyBody/NavarChy15_J1-2/NavarChy15_4.vue'
import Enemy5 from '@/components/NavarChyJ2/NavarChyBody/NavarChy15_J1-2/NavarChy15_5.vue'
    ...
    if (this.$route.query.id == undefined) {
      ...
      GetRoutePageByTaskId(this.baseUrl, {
        ...
        if (res.data.content == undefined) {
          ...
          this.$store.state.CDcontestant = res.data.content;
        }
      });
  ...
  methods: {
    ...
    saveClick() {
      save(this.baseUrl, {
        ...
        content:   this.$store.state.CDcontestant
      }).then((res) => {
