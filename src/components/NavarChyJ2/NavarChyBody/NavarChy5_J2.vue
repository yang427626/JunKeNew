<template>
  <div class="box">
    <div class="task_title">确定已知事实和制定规划假设</div>
    <div class="Cont">
      <div class="item">
      ...
      <table border="1px solid #fff" class="table_tr">
        <div class="tabke_tr_conter">
          <tr>
            ...
            <th>现有信息能否满足规划需要</th>
            <th>假设描述</th>
            <th :rowspan="tableData.num">
              <i @click="addClick" class="el-icon-circle-plus-outline"></i>
            </th>
          </tr>
...
export default {
  ...
  methods: {
    addClick() {
      ...
      this.tableData.num=this.tableData.tableData.length+1
    },
    // // 拒绝
    refuse_Dialog_Clcik() {
