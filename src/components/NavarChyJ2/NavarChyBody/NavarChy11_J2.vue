<template>
  <div class="box">
    <div class="task_title">制定军事目标</div>
    <div class="Cont">
      <div class="item">
        ...
        <table border="1px solid #fff" class="table_tr">
          <div class="tabke_tr_conter">
            <tr>
              ...
              <th>重心</th>
              <th>最终状态</th>
              <th :rowspan="content.num1">
              <i class="el-icon-circle-plus-outline" @click="Num1Click"></i>
            </th>
            </tr>
            <tr v-for="(item, index) in content.tableData" :key="index">
              <td>
                <input type="text" v-model="item.date1" />
              </td>
              <td>
                <input type="text" v-model="item.date2"/>
              </td>
              <td>
                <input type="text" v-model="item.date3" />
              </td>

              <td>
                <input type="text" v-model="item.date4" />
              </td>
              <td>
                <input type="text" v-model="item.date5" />
              </td>
              <td>
                <input type="text" v-model="item.date6" />
              </td>
            </tr>
      ...
      <div class="item">
        <p class="item_font">军事目标例子:</p>
        <p class="item_font_con"><textarea v-model="content.date3" class="example" /></p>
      </div>
    </div>
...
export default {
  ...
  methods: {
    Num1Click() {
      ...
      this.content.tableData.push(Objuct);
