      ...
      <div class="pro3_item">
        <div class="pro3_a">
          ...
          <div class="textarea_div">
            <textarea v-model="$store.state.CEcontent.CE_J2_4.CE_J2_4_data_progress1"
        ...
        <div class="pro3_a">
          ...
          <div class="textarea_div">
            <textarea v-model="$store.state.CEcontent.CE_J2_4.CE_J2_4_data_progress2"
              :disabled="disabled" class="pro3_b1" />
            <p class="sub_title_p">
              （考虑政治情况对敌人广泛能力的影响。）
            </p>
        ...
        <div class="pro3_a">
          ...
          <div class="textarea_div">
            <textarea v-model="$store.state.CEcontent.CE_J2_4.CE_J2_4_data_progress3"
              :disabled="disabled" class="pro3_b1" />
            <p class="sub_title_p">
              （考虑政治情况对友军广泛作战行动的影响。）
            </p>
