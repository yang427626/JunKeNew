...
<script>
import Enemy1 from '@/components/ComDevelop/CDcontestantJ5_2/NavarChy1.vue'
import Enemy2 from '@/components/ComDevelop/CDcontestantJ5_2/NavarChy2.vue'
import Enemy3 from '@/components/ComDevelop/CDcontestantJ5_2/NavarChy3.vue'
import Enemy4 from '@/components/ComDevelop/CDcontestantJ5_2/NavarChy4.vue'
import Enemy5 from '@/components/ComDevelop/CDcontestantJ5_2/NavarChy5.vue'
    ...
    if (this.$route.query.id == undefined) {
      ...
      GetRoutePageByTaskId(this.baseUrl, {
        ...
        if (res.data.content == undefined) {
          ...
          this.$store.state.CDcontestantJ5_2 = res.data.content;
        }
      });
  ...
  methods: {
    ...
    saveClick() {
      save(this.baseUrl, {
        ...
        content:   this.$store.state.CDcontestantJ5_2
      }).then((res) => {
