<template>
  <div class="guide">
    ...
    <div class="pro4">
      <div class="pro3_item">
        <span class="title"
          >本节分析总体政策、战略指南和对战区或全球形势的权威指导，并确定了全球和区域层面的战略需求。。</span
        >
        <div class="pro3_a">
          <p class="sub_title">a、美国的政策目标</p>
          <div class="textarea_div">
            <textarea v-model="$store.state.CDcontestantJ5_2.CD1.data1" class="pro3_b1" />
            <p class="sub_title_p">
        ...
        <div class="pro3_a">
          ...
          <div class="textarea_div">
            <textarea v-model="$store.state.CDcontestantJ5_2.CD1.data2" class="pro3_b1" />
            <p class="sub_title_p">
        ...
        <div class="pro3_a">
          ...
          <div class="textarea_div">
            <textarea v-model="$store.state.CDcontestantJ5_2.CD1.data3" class="pro3_b1" />
          </div>
        </div>
        <div class="pro3_a">
          <p class="sub_title">d、 最终状态。</p>
          <div class="textarea_div">
            <textarea v-model="$store.state.CDcontestantJ5_2.CD1.data4" class="pro3_b1" />
            <p class="sub_title_p">
