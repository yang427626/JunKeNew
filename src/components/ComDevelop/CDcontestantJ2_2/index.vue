<template>
  <div class="task_conter">
    ...
    <!-- </div>
      ...
      <p class="pro_bom2" v-show="NumShow == 1 && progress>=5" @click="submitClick">提交</p>
       <p class="pro_bom2" v-if="progress<5" @click="nextClick">下一步</p>
    </div>
    <!-- 退回 -->
...
<script>
import Enemy1 from '@/components/ComDevelop/CDcontestantJ2_2/CDcontestantJ2_2Body/NavarChy1.vue'
import Enemy2 from '@/components/ComDevelop/CDcontestantJ2_2/CDcontestantJ2_2Body/NavarChy2.vue'
import Enemy3 from '@/components/ComDevelop/CDcontestantJ2_2/CDcontestantJ2_2Body/NavarChy3.vue'
import Enemy4 from '@/components/ComDevelop/CDcontestantJ2_2/CDcontestantJ2_2Body/NavarChy4.vue'
import Enemy5 from '@/components/ComDevelop/CDcontestantJ2_2/CDcontestantJ2_2Body/NavarChy5.vue'
    ...
    if (this.$route.query.id == undefined) {
      ...
      GetRoutePageByTaskId(this.baseUrl, {
        ...
        if (res.data.content == undefined) {
          ...
          this.$store.state.CDcontestantJ2_2 = res.data.content;
        }
      });
  ...
  methods: {
    ...
    saveClick() {
      save(this.baseUrl, {
        ...
        content:   this.$store.state.CDcontestantJ2_2
      }).then((res) => {
