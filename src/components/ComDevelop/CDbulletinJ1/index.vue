<template>
  <div class="task_conter">
    <div class="task_title">准备任务分析简报</div>
      <div class="progress">
    ...
    <!-- </div>
      ...
      <p class="pro_bom2" v-show="NumShow == 1 && progress>=3" @click="submitClick">提交</p>
       <p class="pro_bom2" v-if="progress<3" @click="nextClick">下一步</p>
    </div>
    <!-- 退回 -->
...
<script>
import Enemy1 from '@/components/ComDevelop/CDbulletinJ1-2/NavarChy1.vue'
import Enemy2 from '@/components/ComDevelop/CDbulletinJ1-2/NavarChy2.vue'
import Enemy3 from '@/components/ComDevelop/CDbulletinJ1-2/NavarChy3.vue'
