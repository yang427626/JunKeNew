<template>
  <div class="box">
    <div class="task_title">评估标准</div>
    <div class="item">
      <p class="item_font">文本名称:</p>
      <p class="item_font_con">
        <textarea v-model="content.data1" class="textName" />
      </p>
      <p class="item_font">文本注意事项:</p>
      <p class="item_font_con">
        <textarea v-model="content.data2" class="textNames" />
      </p>
    </div>
    <div class="table_content">
      <table border="1px solid #fff" class="table_tr">
        <tr>
          <th class="item_td"></th>
          <th class="item_td">兵力防护</th>
          <th class="item_td">决定性的行动</th>
          <th class="item_td">人员伤亡</th>
          <th class="item_td">挫败敌人重心</th>
          <th class="item_td">保障/支援</th>
          <th class="item_td">塑造环境的可观察性/可评估性</th>
          <th class="item_td">时间</th>
          <th class="item_td">灵活性</th>
          <th class="item_td">风险</th>
          <th class="item_td">突然性</th>
        ...
        <tr v-for="(item, index) in content.tableData" :key="index">
          <td>
            <!-- {{ item.model }} -->
            <input type="text" v-model="item.model" name="" id="" />
          </td>
          <td>
          ...
          <td>
            <input type="text" v-model="item.data7" name="" id="" />
          </td>
          <td>
            <input type="text" v-model="item.data8" name="" id="" />
          </td>
          <td>
            <input type="text" v-model="item.data9" name="" id="" />
          </td>
          <td>
            <input type="text" v-model="item.data10" name="" id="" />
          </td>
        </tr>
      </table>
    </div>
    ...
    return {
      ...
      content: {
        ...
        tableData: [
          ...
          {
            model: "衡量标准（可量的话写基准和量纲、不可量化的写描述）",
            data1: "",
            data2: "",
            data3: "",
            data4: "",
