<template>
  <div class="NavarchySin">
    <div class="task_title">指挥官意图</div>
    <div class="item">
    ...
    <div class="item">
      ...
      <p class="item_font_con">
        <textarea v-model="content.data2" class="text" />
      </p>
    </div>
    <div class="item">
      <p class="item_font">问题的界定:</p>
      <p class="item_font_con">
        <textarea v-model="content.data3" class="text" />
      </p>
    </div>
    <div class="item">
      <p class="item_font">行动方法:</p>
      <p class="item_font_con">
        <textarea v-model="content.data4" class="text" />
      </p>
    </div>
    <div class="item">
      <p class="item_font">初始意图:</p>
      <p class="item_font_con">
        <textarea v-model="content.data5" class="textarea" />
      </p>
    </div>
   <div class="pro_bom">
