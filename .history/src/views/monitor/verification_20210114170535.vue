<template>
  <div class="verification">
    ...
    >
      ...
      <el-table-column label="APP名称" prop="appName" width="110px" align="center">
        <template slot-scope="{ row }">
      ...
      <el-table-column label="APP内容"  min-width="150px">
        <template slot-scope="{ row }">
          ...
          <br>
          <span class="link-type">内容：<span v-html="row.articleContent" /> </span>
          <!-- <span class="link-type" @click="handleUpdate(row)">{{ row.content }}</span> -->
          <!-- <el-tag>{{ row.type | typeFilter }}</el-tag> -->
        </template>
      </el-table-column>
      <el-table-column label="敏感词" prop="keywordName" width="110px" align="center">
        <template slot-scope="{ row }">
      ...
      <el-table-column label="处置源头" prop="isDisposal" class-name="status-col" width="100">
        <template slot-scope="{ row }">
